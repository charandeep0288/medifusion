        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            {isEditing ? (
              ...
              <p className="text-gray-900 font-medium">
                {safePatient.incoming.medical_conditions.join(", ") || "None"}
              </p>
            )}
          </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                <p className="text-sm text-gray-600">
                  ...
                  <span className="text-gray-800">{safePatient.method}</span>
                </p>
              </div>
              <div>
                <p className="text-sm text-gray-600">
                  ...
                  <span className="text-gray-800">{safePatient.score}%</span>
                </p>
              </div>
              <div>
                <p className="text-sm text-gray-600">
                  <span className="font-medium text-indigo-700">Status:</span>{" "}
                  <span className="text-gray-800">{safePatient.status}</span>
                </p>
              </div>
            </div>
          </div>
